...
public class RepositoryAdminManageHandler {
	...
	public @ResponseBody Map<String, Object> getRepositoryAdmin(@RequestParam("searchType") String searchType,
	...
	public @ResponseBody Map<String, Object> addRepositoryAdmin(@RequestBody RepositoryAdmin repositoryAdmin) {
		// 初始化结果集
		Map<String, Object> resultSet = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> getRepositoryAdminInfo(Integer repositoryAdminID) {
		// 初始化结果集
		Map<String, Object> resultSet = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> updateRepositoryAdmin(@RequestBody RepositoryAdmin repositoryAdmin) {
		// 初始化结果集
		Map<String, Object> resultSet = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> deleteRepositoryAdmin(Integer repositoryAdminID) {
		// 初始化结果集
		Map<String, Object> resultSet = new HashMap<>();
	...
	public @ResponseBody Map<String, Object> importRepositoryAdmin(MultipartFile file) {
		// 初始化结果集
		Map<String, Object> resultSet = new HashMap<>();
		String result = ResponseStatus.ERROR.toString();
