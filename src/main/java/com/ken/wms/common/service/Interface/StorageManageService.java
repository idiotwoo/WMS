...
public interface StorageManageService {
	 ...
	 */
	public Map<String, Object> selectAll(Integer repositoryID);
	 ...
	 * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
	 */
	public Map<String, Object> selectByGoodsID(Integer goodsID, Integer repositoryID);
	 ...
	 * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
	 */
	public Map<String, Object> selectByGoodsName(String goodsName, Integer repositoryID);
	 ...
	 * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
	 */
	public Map<String, Object> selectByGoodsType(String goodsType, Integer Repository);
