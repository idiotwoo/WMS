...
public class StorageManageHandler {
	...
	public @ResponseBody Map<String, Object> increaseStorage(@RequestParam("supplierID") Integer supplierID, 
		...
		String result = stockRecordManageService.stockInOperation(supplierID, goodsID, repositoryID, number, personInCharge) ?
				com.ken.wms.controller.Enum.ResponseStatus.SUCCESS.toString() : com.ken.wms.controller.Enum.ResponseStatus.ERROR.toString();
	...
	public @ResponseBody Map<String, Object> addStorageRecord(@RequestBody Map<String, Object> params) {
		...
		String isSuccess = com.ken.wms.controller.Enum.ResponseStatus.ERROR.toString();
		...
		if (isAvailable) {
			isSuccess = storageManageService.addNewStorage(Integer.valueOf(goodsID), Integer.valueOf(repositoryID),
					Integer.valueOf(number)) ? com.ken.wms.controller.Enum.ResponseStatus.SUCCESS.toString() : com.ken.wms.controller.Enum.ResponseStatus.ERROR.toString();
		}
